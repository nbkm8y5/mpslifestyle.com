...
<head>
    ...
    <title>Mental, Physical, Spiritual - Dry Fit Sports Apparel Contact Form</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/brand_contact.css">
...
<section id="navigationBar">
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="row">
                <div id="navMargin" class="pull-left col-md-4 col-xs-12 col-lg-6 navList navMargin">
                    <ul>
                ...
                <div id="navMargin" class="pull-right col-md-4 col-xs-12 col-lg-6 navList navMargin">
                    <ul>
                        <li><a id="menu" href="contact.php">Contact Us</a></li>
                        <li class="storeColor"><a id="menu" href="https://viralstyle.com/mpslifestyle2015/mpslivefearless-2#pid=35&cid=1416170&sid=front">Store</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img id="byron" src="images/contact.jpg" alt="contact_us" class="image-responsive img-rounded">
                <div class="carousel-caption">
                    <img src="images/avatar.png" height="100">
                    <h2>Located in Miami, Florida</h2>
                    <h2>You can also email us at</h2>
                    <h2><a href="mailto:info@mpslifestyle.com">info@mpslifestyle.com</a></h2>
